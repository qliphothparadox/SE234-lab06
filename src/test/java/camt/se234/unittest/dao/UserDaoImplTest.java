...
public class UserDaoImplTest {
    ...
    public void testGetUsers(){
        ...
        assertThat(userDao.getUsers(),
                containsInAnyOrder(
                        new User("NoName","none","None",LocalDate.of(2112,01,01),"9999999999"),
                        new User("Tucky","5675","Tuckung", LocalDate.of(2014,11,22),"08687654321"),
                        new User("Prayuth","1234","Tu", LocalDate.of(2016,12,28),"08612345678"),
